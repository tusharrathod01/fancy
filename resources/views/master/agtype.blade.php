                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">A/G TYPE MASTER</h3>
                        </div>
...
@push('script')
    ...
    <script type="text/javascript">
            ...
            if (Length == 0 && check !== '') {
                var markup = `<tr>
                        ...
                        <td style="width: 100px">
                           ...
                           <input type="hidden" name="masters[${row}][type]"  value="agtype_master">
        ...
        function get_agtype() {
            postAjax("{{ route('get.masters', 'agtype_master') }}", {
                '_token': "{{ csrf_token() }}"
            }, function(res) {
                if (res.status == 'Success') {
                    setData(res.data);
            ...
            $.each(data, function(i, color) {
                html += `<tr>
                        ...
                        <td>
                           ...
                           <input type="hidden" name="masters[${i}][type]"  value="agtype_master">
