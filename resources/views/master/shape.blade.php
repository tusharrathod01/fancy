                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">SHAPE MASTER</h3>
                        </div>
                        <div class="card-body table-responsive p-0 shapetbl">
...
@push('script')
    ...
    <script type="text/javascript">
            ...
            if (Length == 0 && check !== '') {
                var markup = `<tr>
                        ...
                        <td style="width: 100px">
                           ...
                           <input type="hidden" name="masters[${row}][type]"  value="shape_master">
                        </td>
                        <td>
        ...
        function get_shape() {
            postAjax("{{ route('get.masters', 'shape_master') }}", {
                '_token': "{{ csrf_token() }}"
            }, function(res) {
                if (res.status == 'Success') {
                    setData(res.data);
            ...
            $.each(data, function(i, color) {
                html += `<tr>
                        ...
                        <td>
                           ...
                           <input type="hidden" name="masters[${i}][type]"  value="shape_master">
                        </td>
                     </tr>`;
            });
