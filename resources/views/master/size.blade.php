            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body table-responsive p-0 sizetbl">
...
@push('script')
    ...
    <script type="text/javascript">
            ...
            if (Length == 0 && check !== '') {
                var markup = `<tr>
                        ...
                        <td style="width: 100px">
                           ...
                           <input type="hidden" name="masters[${row}][type]"  value="size_master">
                        </td>
                        <td>
                           <input class="name add-row" type="text" name="masters[${row}][name]">
                        </td>
                        <td>
                           <input class="p_from" type="text" name="masters[${row}][p_from]">
                        </td>
                        <td>
                           <input class="p_to" type="text" name="masters[${row}][p_to]">
                        </td>
                     </tr>`;
        ...
        function get_size() {
            postAjax("{{ route('get.masters', 'size_master') }}", {
                '_token': "{{ csrf_token() }}"
            }, function(res) {
                if (res.status == 'Success') {
                    setData(res.data);
            ...
            $.each(data, function(i, color) {
                html += `<tr>
                        ...
                        <td>
                           ...
                           <input type="hidden" name="masters[${i}][type]"  value="size_master">
                        </td>
                        <td>
                           <input class="p_from" type="number" name="masters[${i}][p_from]" value="${isNull(color.p_from)}">
                        </td>
                        <td>
                           <input class="p_to" type="number" name="masters[${i}][p_to]" value="${isNull(color.p_to)}">
                        </td>
                     </tr>`;
            });
