                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">COLOR MASTER</h3>
                        </div>
                        <div class="card-body table-responsive p-0 colortbl">
...
@push('script')
    ...
    <script type="text/javascript">
            ...
            if (Length == 0 && check !== '') {
                var markup = `<tr>
                        ...
                        <td style="width: 100px">
                           ...
                           <input type="hidden" name="masters[${row}][type]"  value="color_master">

                           <input type="hidden" name="masters[${row}][is_selected]"  value="">
                        </td>
                        <td class="tlotno">
                           <input class="name add-row" type="text" name="masters[${row}][name]">
                        </td>
                        <td>
                           <input class="intensity" type="text" name="masters[${row}][intensity]">
                        </td>
                        <td>
                           <input class="overtone" type="text" name="masters[${row}][overtone]">
                        </td>
                        <td>
                           <input class="color" type="text" name="masters[${row}][color]">
                        </td>
                        <td>
                           <input class="st_name" type="text" name="masters[${row}][st_name]">
                        </td>
                     </tr>`;
        ...
        function get_color() {
            postAjax("{{ route('get.masters', 'color_master') }}", {
                '_token': "{{ csrf_token() }}"
            }, function(res) {
                if (res.status == 'Success') {
                    setData(res.data);
            ...
            $.each(data, function(i, color) {
                html += `<tr>
                        ...
                        <td>
                           ...
                           <input type="hidden" name="masters[${i}][type]"  value="color_master">
                        </td>
                        <td>
                           <input class="intensity" type="text" name="masters[${i}][intensity]" value="${isNull(color.intensity)}">
                        </td>
                        <td>
                           <input class="overtone" type="text" name="masters[${i}][overtone]" value="${isNull(color.overtone)}">
                        </td>
                        <td>
                           <input class="color" type="text" name="masters[${i}][color]" value="${isNull(color.color)}">
                        </td>
                        <td>
                           <input class="st_name" type="text" name="masters[${i}][st_name]"  value="${isNull(color.st_name)}">
                        </td>
                     </tr>`;
            });
