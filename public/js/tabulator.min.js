...
!(function (e, t) {
    ...
    class o extends e {
        ...
        _configureCell() {
            ...
            this.column.vertAlign &&
                ...
                (e.style.alignItems = { top: "flex-start", bottom: "flex-end", middle: "center" }[this.column.vertAlign] || ""),
                this.column.hozAlign && (e.style.justifyContent = { left: "flex-start", right: "flex-end", center: "center" }[this.column.hozAlign] || "")),
    ...
    class n extends e {
        ...
        _initialize() {
            ...
            e.headerVertical && (this.element.classList.add("tabulator-col-vertical"), "flip" === e.headerVertical && this.element.classList.add("tabulator-col-vertical-flip")),
        ...
        updateDefinition(e) {
            ...
            return this.isGroup || this.parent.isGroup
                ...
                : ((t = Object.assign({}, this.getDefinition())),
                  (t = Object.assign(t, e)),
                  this.table.columnManager.addColumn(t, !1, this).then((e) => (t.field == this.field && (this.field = !1), this.delete().then(() => e.getComponent()))));
        }
        deleteCell(e) {
        ...
        static deepClone(e, t, i = []) {
            ...
            for (var n in (t || (t = Object.assign(Array.isArray(e) ? [] : {}, e)), e)) {
                ...
                null == l ||
                    ...
                    ((r = i.findIndex((e) => e.subject === l)), r > -1 ? (t[n] = i[r].copy) : ((a = Object.assign(Array.isArray(l) ? [] : {}, l)), i.unshift({ subject: l, copy: a }), (t[n] = this.deepClone(l, a, i))));
            }
            return t;
        }
    }
    class a {
        ...
        generate(e, t = {}) {
            ...
            if ((Object.assign(i, e), !1 !== t.debugInvalidOptions || this.table.options.debugInvalidOptions)) for (let e in t) i.hasOwnProperty(e) || console.warn("Invalid " + this.msgType + " option:", e);
    ...
    class l extends e {
        ...
        scrollToRowPosition(e, t, i) {
            ...
            return new Promise((a, l) => {
                if (s > -1) {
                    if ((void 0 === i && (i = this.table.options.scrollToRowIfVisible), !i && r.elVisible(o) && (n = r.elOffset(o).top - r.elOffset(this.elementVertical).top) > 0 && n < this.elementVertical.clientHeight - o.offsetHeight))
                        return a(), !1;
                    switch ((void 0 === t && (t = this.table.options.scrollToRowPosition), "nearest" === t && (t = this.scrollToRowNearestTop(e) ? "top" : "bottom"), this.scrollToRow(e), t)) {
                        ...
                        case "center":
                            this.elementVertical.scrollHeight - this.elementVertical.scrollTop == this.elementVertical.clientHeight
                                ? (this.elementVertical.scrollTop = this.elementVertical.scrollTop + (o.offsetTop - this.elementVertical.scrollTop) - (this.elementVertical.scrollHeight - o.offsetTop) / 2)
                                : (this.elementVertical.scrollTop = this.elementVertical.scrollTop - this.elementVertical.clientHeight / 2);
                            break;
                        case "bottom":
                            this.elementVertical.scrollHeight - this.elementVertical.scrollTop == this.elementVertical.clientHeight
                                ? (this.elementVertical.scrollTop = this.elementVertical.scrollTop - (this.elementVertical.scrollHeight - o.offsetTop) + o.offsetHeight)
                                : (this.elementVertical.scrollTop = this.elementVertical.scrollTop - this.elementVertical.clientHeight + o.offsetHeight);
                            break;
                        case "top":
                ...
                this.table.columnManager.columnsByIndex.forEach((e) => {
                    ...
                    e.visible &&
                        (e.modules.frozen ||
                            ...
                            s + t > this.vDomScrollPosLeft && s < this.vDomScrollPosRight
                                ? (-1 == this.leftCol && ((this.leftCol = this.columns.length), (this.vDomPadLeft = s)), (this.rightCol = this.columns.length))
                                : -1 !== this.leftCol && (this.vDomPadRight += t),
                            this.columns.push(e),
                            (e.modules.vdomHoz = i),
                            (s += t)));
                }),
            ...
            if (this.isFitData) {
                if (
                    ...
                    i &&
                        ...
                        ((this.vDomScrollPosRight = this.scrollLeft + this.elementVertical.clientWidth + this.windowBuffer), (e = this.chain("rows-sample", [1], [], () => this.table.rowManager.getDisplayRows())[0])))
                ) {
        ...
        fitDataColActualWidthCheck(e) {
            ...
            return (
                e.modules.vdomHoz.fitDataCheck &&
                    (e.reinitializeWidth(),
                    (i = (t = e.getWidth()) - e.modules.vdomHoz.width) && ((e.modules.vdomHoz.rightPos += i), (e.modules.vdomHoz.width = t), this.colPositionAdjust(this.columns.indexOf(e) + 1, this.columns.length, i)),
    ...
    class c extends e {
        constructor(e) {
            super(e),
                ...
                (this.columnsByField = {}),
                (this.scrollLeft = 0),
                (this.optionsList = new a(this.table, "column definition", i)),
                (this.redrawBlock = !1),
        ...
        initializeRenderer() {
            var e,
                t = { virtual: d, basic: h };
            (e = "string" == typeof this.table.options.renderHorizontal ? t[this.table.options.renderHorizontal] : this.table.options.renderHorizontal)
                ? ((this.renderer = new e(this.table, this.element, this.tableElement)), this.renderer.initialize())
        ...
        redraw(e) {
            r.elVisible(this.element) && this.verticalAlignHeaders(),
                e && (this.table.rowManager.resetScroll(), this.table.rowManager.reinitialize()),
        ...
        calcHeight(e) {
            ...
            this.table.options.rowHeight
                ...
                : ((t = this.table.options.resizableRows ? this.element.clientHeight : 0),
                  ...
                  (this.height = e ? Math.max(i, t) : this.manualHeight ? this.height : Math.max(i, t))),
        ...
        updateData(e) {
            ...
            return new Promise((o, n) => {
                "string" == typeof e && (e = JSON.parse(e)),
                    ...
                    this.subscribed("row-data-changing") && ((s = Object.assign(s, this.data)), (s = Object.assign(s, e))),
    ...
    class g extends l {
        ...
        rerenderRows(e) {
            ...
            n.forEach((e) => {
                ...
                e && e(),
                this.rows().length ? this._virtualRenderFill(!1 === i ? this.rows.length - 1 : i, !0, s || 0) : (this.clear(), this.table.rowManager._showPlaceholder()),
        ...
        _virtualRenderFill(e, t, i) {
            var s = this.tableElement,
                ...
                c = this.rows(),
                u = c.length,
                p = this.elementVertical.clientHeight;
            if (((i = i || 0), (e = e || 0))) {
                for (; s.firstChild; ) s.removeChild(s.firstChild);
                (l = (u - e + 1) * this.vDomRowHeight) < p && (e -= Math.ceil((p - l) / this.vDomRowHeight)) < 0 && (e = 0),
                    (e -= n = Math.min(Math.max(Math.floor(this.vDomWindowBuffer / this.vDomRowHeight), this.vDomWindowMinMarginRows), e));
            } else this.clear();
            if (u && r.elVisible(this.elementVertical)) {
                for (this.vDomTop = e, this.vDomBottom = e - 1; (a <= p + this.vDomWindowBuffer || d < this.vDomWindowMinTotalRows) && this.vDomBottom < u - 1; ) {
                    var m,
                        ...
                        b = c[g];
                    this.styleRow(b, g),
                        s.appendChild(b.getElement()),
                        b.initialize(),
                        b.heightInitialized || b.normalizeHeight(!0),
                        (m = b.getHeight()),
                        d < n ? (h += m) : (a += m),
                        m > this.vDomWindowBuffer && (this.vDomWindowBuffer = 2 * m),
                        this.vDomBottom++,
                        d++;
                }
                e
                    ? ((this.vDomTopPad = t ? this.vDomRowHeight * this.vDomTop + i : this.scrollTop - h), (this.vDomBottomPad = this.vDomBottom == u - 1 ? 0 : Math.max(this.vDomScrollHeight - this.vDomTopPad - a - h, 0)))
                    : ((this.vDomTopPad = 0), (this.vDomRowHeight = Math.floor((a + h) / d)), (this.vDomBottomPad = this.vDomRowHeight * (u - this.vDomBottom - 1)), (this.vDomScrollHeight = h + a + this.vDomBottomPad - p)),
                    (s.style.paddingTop = this.vDomTopPad + "px"),
                    (s.style.paddingBottom = this.vDomBottomPad + "px"),
                    t && (this.scrollTop = this.vDomTopPad + h + i - (this.elementVertical.scrollWidth > this.elementVertical.clientWidth ? this.elementVertical.offsetHeight - p : 0)),
                    (this.scrollTop = Math.min(this.scrollTop, this.elementVertical.scrollHeight - p)),
                    this.elementVertical.scrollWidth > this.elementVertical.offsetWidth && t && (this.scrollTop += this.elementVertical.offsetHeight - p),
        ...
        _addTopRow(e, t) {
            for (var i = this.tableElement, s = [], o = 0, n = this.vDomTop - 1, r = 0, a = !0; a; )
                if (this.vDomTop) {
                    let l,
                        h,
                        d = e[n];
                    d && r < this.vDomMaxRenderChain
                        ? ((l = d.getHeight() || this.vDomRowHeight),
                          (h = d.initialized),
                          t >= l
                              ? (this.styleRow(d, n),
                                ...
                                d.initialize(),
                                h || ((l = d.getElement().offsetHeight), l > this.vDomWindowBuffer && (this.vDomWindowBuffer = 2 * l)),
                                (t -= l),
                                (o += l),
                                this.vDomTop--,
                                n--,
            ...
            this._quickNormalizeRowHeight(s),
                o && ((this.vDomTopPad -= o), this.vDomTopPad < 0 && (this.vDomTopPad = n * this.vDomRowHeight), n < 1 && (this.vDomTopPad = 0), (i.style.paddingTop = this.vDomTopPad + "px"), (this.vDomScrollPosTop -= o));
        }
        _removeTopRow(e, t) {
    ...
    class b extends e {
            ...
            this.initializePlaceholder(),
                ...
                this.element.addEventListener("scroll", () => {
                    var e = this.element.scrollLeft,
                        ...
                        s = this.scrollTop > i;
                    this.scrollLeft != e && ((this.scrollLeft = e), this.dispatch("scroll-horizontal", e, t), this.dispatchExternal("scrollHorizontal", e, t), this._positionPlaceholder()),
                        this.scrollTop != i && ((this.scrollTop = i), this.renderer.scrollRows(i, s), this.dispatch("scroll-vertical", i, s), this.dispatchExternal("scrollVertical", i, s));
                });
        }
        findRow(e) {
            if ("object" != typeof e) {
                ...
                if (this.redrawBlock)
                    return void (
                        (!this.redrawBlockRestoreConfig ||
                            (this.redrawBlockRestoreConfig && ((this.redrawBlockRestoreConfig.stage === o && n < this.redrawBlockRestoreConfig.index) || a.indexOf(o) < a.indexOf(this.redrawBlockRestoreConfig.stage)))) &&
                        (this.redrawBlockRestoreConfig = { handler: e, skipStage: t, renderInPosition: i, stage: o, index: n })
                    );
                r.elVisible(this.element)
                    ? i
                        ? this.reRenderInPosition(this.refreshPipelines.bind(this, e, o, n, i))
                        : (this.refreshPipelines(e, o, n, i), e || this.table.columnManager.renderer.renderColumns(), this.renderTable(), s.options.layoutColumnsOnNewData && this.table.columnManager.redraw(!0))
                    : this.refreshPipelines(e, o, n, i),
        ...
        reRenderInPosition(e) {
            this.redrawBlock
                ...
                : (this.dispatchExternal("renderStarted"), this.renderer.rerenderRows(e), this.fixedHeight || this.adjustTableSize(), this.scrollBarCheck(), this.dispatchExternal("renderComplete"));
        }
        scrollBarCheck() {
            var e = 0;
        ...
        initializeRenderer() {
            ...
            (e = "string" == typeof this.table.options.renderVertical ? t[this.table.options.renderVertical] : this.table.options.renderVertical)
                ? ((this.renderMode = this.table.options.renderVertical),
                  ...
                  this.table.element.clientHeight || this.table.options.height ? (this.fixedHeight = !0) : (this.fixedHeight = !1))
        ...
        renderTable() {
            this.dispatchExternal("renderStarted"),
                ...
                this._clearTable(),
                this.displayRowsCount ? (this.renderer.renderRows(), this.firstRender && ((this.firstRender = !1), this.layoutRefresh(!0))) : this.renderEmptyScroll(),
            ...
            if ("fill" === this.renderer.verticalFillMode) {
                ...
                this.fixedHeight
                    ? ((e = isNaN(this.table.options.minHeight) ? this.table.options.minHeight : this.table.options.minHeight + "px"),
                      (this.element.style.minHeight = e || "calc(100% - " + i + "px)"),
                    ...
                    this.fixedHeight || t == this.element.clientHeight || (this.subscribed("table-resize") ? this.dispatch("table-resize") : this.redraw()),
                    this.scrollBarCheck();
            }
    ...
    class v extends e {
        ...
        pseudoMouseEnter(e, t, i) {
            this.pseudoTrackers[e].target !== i &&
                (this.pseudoTrackers[e].target && this.dispatch(e + "-mouseleave", t, this.pseudoTrackers[e].target), this.pseudoMouseLeave(e, t), (this.pseudoTrackers[e].target = i), this.dispatch(e + "-mouseenter", t, i));
        }
        ...
        subscriptionChanged(e, t, i) {
            var s = this.listeners[t].components,
                o = s.indexOf(e),
                n = !1;
            i ? -1 === o && (s.push(e), (n = !0)) : this.subscribed(e + "-" + t) || (o > -1 && (s.splice(o, 1), (n = !0))),
                    ...
                    switch (e) {
                        ...
                        case "cell":
                            s.components.includes("cell") &&
                                (o.row instanceof p
                                    ? (i = o.row.findCell(r))
                                    : t.row && console.warn("Event Target Lookup Error - The row this cell is attached to cannot be found, has the table been reinitialized without being destroyed first?"));
                    }
    ...
    class w {
        ...
        handle(e, t, i) {
            ...
            "then" === i ||
                "string" != typeof i ||
                i.startsWith("_") ||
                (this.table.options.debugInvalidComponentFuncs && console.error("The " + e + " component does not have a " + i + " function, have you checked that you have the correct Tabulator module installed?"));
        }
    }
    class C extends e {
        constructor(e) {
                    ...
                    ? ((this.loading = !0),
                      ...
                      this.chain("data-load", [e, t, i, o], !1, Promise.resolve([]))
                          .then((e) => {
                              ...
                              r == this.requestOrder
                                  ? (this.clearAlert(), !1 !== t && (this.dispatchExternal("dataLoaded", t), this.table.rowManager.setData(t, s, void 0 === n ? !s : n)))
    ...
    class R extends e {
        ...
        check(e, t) {
            ...
            return (
                ...
                ((i = "Deprecated Setup Option - Use of the %c" + e + "%c option is now deprecated"),
                t
                    ? ((i = i + ", Please use the %c" + t + "%c option instead"), this._warnUser(i, "font-weight: bold;", "font-weight: normal;", "font-weight: bold;", "font-weight: normal;"))
    ...
    class x {
        ...
        static lookupTable(e, t) {
            ...
            if ("string" == typeof e) {
                ...
                ("undefined" != typeof HTMLElement && e instanceof HTMLElement) || e instanceof O
                    ? (s = x.matchElement(e)) && o.push(s)
                    : Array.isArray(e)
                    ? e.forEach(function (e) {
    ...
    class T extends e {
        ...
        _lookupContainer() {
            ...
            return (
                "string" == typeof e
                    ? (e = document.querySelector(e)) || console.warn("Menu Error - no container element found matching selector:", this.table.options.popupContainer, "(defaulting to document body)")
                    : !0 === e && (e = this.table.element),
                e && !this._checkContainerIsParent(e) && ((e = !1), console.warn("Menu Error - container element does not contain this table:", this.table.options.popupContainer, "(defaulting to document body)")),
                e || (e = document.body),
                e
            );
        }
            ...
            return (
                this.destroyed ||
                    ...
                    (e instanceof HTMLElement
                        ? ((o = e), (n = (r = this.elementPositionCoords(e, t)).offset), (i = r.x), (s = r.y))
                        : "number" == typeof e
                        ? ((n = { top: 0, left: 0 }), (i = e), (s = t))
                        : ((i = (r = this.containerEventCoords(e)).x), (s = r.y), (this.reversedX = !1)),
        ...
        _fitToScreen(e, t, i, s, o) {
            ...
            if (
                ((e + this.element.offsetWidth >= this.container.offsetWidth || this.reversedX) &&
                    ((this.element.style.left = ""), (this.element.style.right = i ? this.container.offsetWidth - s.left + "px" : this.container.offsetWidth - e + "px"), (this.reversedX = !0)),
    ...
    class k extends e {
        ...
        displayRows(e) {
            ...
            if ((this._handler && (t = this.table.rowManager.displayPipeline.findIndex((e) => e.handler === this._handler)) > -1 && (i = t), e && (i += e), this._handler))
    ...
    var L = {
        ...
        fitDataStretch: function (e, t) {
            ...
            e.forEach((e, t) => {
                ...
                n
                    ? ((o = s - i + n.getWidth()),
                      this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && (n.setWidth(0), this.table.modules.responsiveLayout.update()),
                      o > 0 ? n.setWidth(o) : n.reinitializeWidth())
                    : this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update();
        },
                ...
                return (
                    e.forEach(function (e, n) {
                        ...
                        e.column.minWidth >= r
                            ...
                            ? ((e.width = e.column.maxWidth), (t -= e.column.maxWidth), (h -= s ? e.column.definition.widthShrink || 1 : e.column.definition.widthGrow || 1) && (i = Math.floor(t / h)))
                            : (m.push(e), (c += s ? e.column.definition.widthShrink || 1 : e.column.definition.widthGrow || 1));
                    }),
                    o.length
            ...
            this.table.options.responsiveLayout && this.table.modExists("responsiveLayout", !0) && this.table.modules.responsiveLayout.update(),
                ...
                e.forEach(function (e) {
                    ...
                    e.visible &&
                        ...
                        t
                            ? ((s = u(t)), (n += s > i ? s : i), e.definition.widthShrink && (h.push({ column: e, width: s > i ? s : i }), (d += e.definition.widthShrink)))
                            : (l.push({ column: e, width: 0 }), (a += e.definition.widthGrow || 1)));
                }),
                (r = o - n),
                (i = Math.floor(r / a)),
                (c = p(l, r, i, !1)),
                ...
                (s = Math.abs(c) + r) > 0 && d && (c = p(h, s, Math.floor(s / d), !0)),
    ...
    class S extends k {
        ...
        setLocale(e) {
            if ((!0 === (e = e || "default") && navigator.language && (e = navigator.language.toLowerCase()), e && !this.langList[e])) {
                let t = e.split("-")[0];
                this.langList[t]
                    ? (console.warn("Localization Error - Exact matching locale not found, using closest match: ", e, t), (e = t))
                    : (console.warn("Localization Error - Matching locale not found, using default: ", e), (e = "default"));
            }
            (this.locale = e),
                (this.lang = r.deepClone(this.langList.default || {})),
                "default" != e &&
                    (function e(t, i) {
    ...
    P.moduleName = "comms";
    var z = Object.freeze({ __proto__: null, LayoutModule: D, LocalizeModule: S, CommsModule: P });
    class F {
        constructor(e, t) {
    ...
    class O {
        constructor(e, t) {
            (this.options = {}),
                ...
                (this.componentFunctionBinder = new w(this)),
                (this.dataLoader = !1),
                (this.modules = {}),
                (this.modulesCore = []),
                (this.modulesRegular = []),
                (this.deprecationAdvisor = new R(this)),
                (this.optionsList = new a(this, "table constructor")),
                (this.initialized = !1),
                (this.destroyed = !1),
        ...
        initializeCoreSystems(e) {
            (this.columnManager = new c(this)),
                (this.rowManager = new b(this)),
                (this.footerManager = new f(this)),
                (this.dataLoader = new C(this)),
                (this.alertManager = new H(this)),
                this.bindModules(),
                (this.options = this.optionsList.generate(O.defaultOptions, e)),
                this._clearObjectPointers(),
                this._mapDeprecatedFunctionality(),
                (this.externalEvents = new E(this, this.options, this.options.debugEventsExternal)),
                (this.eventBus = new y(this.options.debugEventsInternal)),
                (this.interactionMonitor = new v(this)),
        ...
        initGuard(e, t) {
            ...
            return (
                this.options.debugInitialization &&
                    !this.initialized &&
                    (e || (e = " " == (s = "Error" == (i = new Error().stack.split("\n"))[0] ? i[2] : i[1])[0] ? s.trim().split(" ")[1].split(".")[1] : s.trim().split("@")[0]),
                    console.warn(
                        "Table Not Initialized - Calling the " + e + " function before the table is initialized may result in inconsistent behavior, Please wait for the `tableBuilt` event before calling this function." + (t ? " " + t : "")
                    )),
                this.initialized
            );
        }
        ...
        updateRow(e, t) {
            ...
            return (
                ...
                i ? i.updateData(t).then(() => Promise.resolve(i.getComponent())) : (console.warn("Update Error - No matching row found:", e), Promise.reject("Update Error - No matching row found"))
            );
        }
        scrollToRow(e, t, i) {
        ...
        transformRow(e, t) {
            ...
            return (
                this.table.columnManager.traverse(function (e) {
                    var n, r, a, l;
                    e.modules.accessor &&
                        (r = e.modules.accessor[i] || e.modules.accessor.accessor || !1) &&
                        "undefined" != (n = e.getFieldValue(o)) &&
                        ((l = e.getComponent()), (a = "function" == typeof r.params ? r.params(n, o, t, l, s) : r.params), e.setFieldValue(o, r.accessor(n, o, t, a, l, s)));
                }),
                o
            );
        }
    ...
    class W extends k {
        constructor(e) {
            super(e),
                ...
                (this.contentTypeFormatters = W.contentTypeFormatters);
        }
        initialize() {
            (this.loaderPromise = this.table.options.ajaxRequestFunc || W.defaultLoaderPromise),
                (this.urlGenerator = this.table.options.ajaxURLGenerator || W.defaultURLGenerator),
        ...
        sendRequest(e, t, i) {
            ...
            return !1 !== this.table.options.ajaxRequesting.call(this.table, e, t)
                ? this.loaderPromise(e, i, t).then((i) => (this.table.options.ajaxResponse && (i = this.table.options.ajaxResponse.call(this.table, e, t, i)), i))
                : Promise.reject();
        }
    }
    (W.moduleName = "ajax"),
        (W.defaultConfig = { method: "GET" }),
        (W.defaultURLGenerator = V),
        (W.defaultLoaderPromise = function (e, t, i) {
            var s;
            return new Promise((o, n) => {
                    ...
                    this.table.element.addEventListener("copy", (e) => {
                        ...
                        this.blocked ||
                            ...
                            this.customSelection
                                ...
                                : ((s = this.table.modules.export.generateExportList(this.table.options.clipboardCopyConfig, this.table.options.clipboardCopyStyled, this.rowRange, "clipboard")),
                                  (t = (i = this.table.modules.export.generateHTMLTable(s)) ? this.generatePlainContent(s) : ""),
                                  this.table.options.clipboardCopyFormatter && ((t = this.table.options.clipboardCopyFormatter("plain", t)), (i = this.table.options.clipboardCopyFormatter("html", i)))),
                            window.clipboardData && window.clipboardData.setData
                                ? window.clipboardData.setData("Text", t)
                                : e.clipboardData && e.clipboardData.setData
                                ? (e.clipboardData.setData("text/plain", t), i && e.clipboardData.setData("text/html", i))
                                : e.originalEvent && e.originalEvent.clipboardData.setData && (e.originalEvent.clipboardData.setData("text/plain", t), i && e.originalEvent.clipboardData.setData("text/html", i)),
            ...
            (this.blocked = !1),
                ...
                (!0 !== this.mode && "copy" !== this.mode) ||
                    ...
                    void 0 !== window.getSelection && void 0 !== document.createRange
                        ? ((e = document.createRange()).selectNodeContents(this.table.element), (i = window.getSelection()).toString() && t && (this.customSelection = i.toString()), i.removeAllRanges(), i.addRange(e))
                        : void 0 !== document.selection && void 0 !== document.body.createTextRange && ((s = document.body.createTextRange()).moveToElementText(this.table.element), s.select()),
        ...
        paste(e) {
            ...
            this.checkPaseOrigin(e) &&
                ...
                (i = this.pasteParser.call(this, t))
                    ? (e.preventDefault(), this.table.modExists("mutator") && (i = this.mutateData(i)), (s = this.pasteAction.call(this, i)), this.dispatchExternal("clipboardPasted", t, i, s))
    ...
    class X extends k {
        ...
        cellValueChanged(e) {
            (e.column.definition.topCalc || e.column.definition.bottomCalc) &&
                (this.table.options.groupBy
                    ? (("table" != this.table.options.columnCalcs && "both" != this.table.options.columnCalcs) || this.recalcActiveRows(), "table" != this.table.options.columnCalcs && this.recalcRowGroup(e.row))
        ...
        removeCalcs() {
            ...
            this.topInitialized && ((this.topInitialized = !1), this.topElement.parentNode.removeChild(this.topElement), (e = !0)),
                this.botInitialized && ((this.botInitialized = !1), this.footerRemove(this.botElement), (e = !0)),
        ...
        recalcGroup(e) {
            ...
            this.blockCheck() ||
                (e &&
                    e.calcs &&
                    (e.calcs.bottom && ((t = this.rowsToData(e.rows)), (i = this.generateRowData("bottom", t)), e.calcs.bottom.updateData(i), e.calcs.bottom.reinitialize()),
                    e.calcs.top && ((t = this.rowsToData(e.rows)), (i = this.generateRowData("top", t)), e.calcs.top.updateData(i), e.calcs.top.reinitialize())));
        }
        generateTopRow(e) {
        ...
        generateRow(e, t) {
            ...
            return (
                ...
                (i.component = !1),
                (i.getComponent = () => (i.component || (i.component = new G(i)), i.component)),
                (i.generateCells = () => {
                    var t = [];
                    this.table.columnManager.columnsByIndex.forEach((s) => {
                        this.genColumn.setField(s.getField()),
                            ...
                            s.definition[e + "CalcFormatter"] && this.table.modExists("format")
                                ? (this.genColumn.modules.format = { formatter: this.table.modules.format.getFormatter(s.definition[e + "CalcFormatter"]), params: s.definition[e + "CalcFormatterParams"] || {} })
                ...
                switch (
                    ...
                    t.dataTreeCollapseElement
                        ? "string" == typeof t.dataTreeCollapseElement
                            ? (((e = document.createElement("div")).innerHTML = t.dataTreeCollapseElement), (this.collapseEl = e.firstChild))
                    ...
                    t.dataTreeExpandElement
                        ? "string" == typeof t.dataTreeExpandElement
                            ? (((e = document.createElement("div")).innerHTML = t.dataTreeExpandElement), (this.expandEl = e.firstChild))
        ...
        getChildren(e, t) {
            ...
            return (
                !1 !== i.children &&
                    ...
                    (s = this.table.modExists("filter") && this.table.options.dataTreeFilter ? this.table.modules.filter.filter(i.children) : i.children),
                    this.table.modExists("sort") && this.table.options.dataTreeSort && this.table.modules.sort.sort(s),
                    s.forEach((e) => {
                        o.push(e),
                            this.getChildren(e).forEach((e) => {
                                o.push(e);
            ...
            return (
                "object" == typeof e
                    ? e instanceof p
                        ...
                        ? t.modules.dataTree && (i = t.modules.dataTree.children.find((t) => t instanceof p && t.element === e)) && (i = i.data)
                        : null === e && (i = !1)
                    : (i = void 0 !== e && t.data[this.field].find((t) => t.data[this.table.options.index] == e)),
        ...
        xlsx: function (t, i, s) {
            ...
            function l() {
                var e = [],
                    i = [],
                    s = {},
                    o = { s: { c: 0, r: 0 }, e: { c: t[0] ? t[0].columns.reduce((e, t) => e + (t && t.width ? t.width : 1), 0) : 0, r: t.length } };
                return (
                    t.forEach((t, s) => {
                        var o = [];
                        t.columns.forEach(function (e, t) {
                            e
                                ? (o.push(e.value instanceof Date || "object" != typeof e.value ? e.value : JSON.stringify(e.value)),
                                  (e.width > 1 || e.height > -1) && (e.height > 1 || e.width > 1) && i.push({ s: { r: s, c: t }, e: { r: s + e.height - 1, c: t + e.width - 1 } }))
                                : o.push("");
                        }),
                            e.push(o);
                    }),
            ...
            if (((n.SheetNames = []), (n.Sheets = {}), i.sheetOnly)) s(l());
                ...
                if (i.sheets)
                    for (var h in i.sheets)
                        !0 === i.sheets[h]
                            ? (n.SheetNames.push(h), (n.Sheets[h] = l()))
                            : (n.SheetNames.push(h),
                              r.commsSend(i.sheets[h], "download", "intercept", {
                                  type: "xlsx",
                                  options: { sheetOnly: !0 },
                                  active: this.active,
                ...
                i.documentProcessing && (n = i.documentProcessing(n)),
                    s(
                        (function (e) {
                            ...
                            return t;
                        })(XLSX.write(n, { bookType: "xlsx", bookSST: !0, type: "binary", compression: a })),
                ...
                (o
                    ...
                    : ((s = s || "Tabulator." + ("function" == typeof i ? "txt" : i)),
                      navigator.msSaveOrOpenBlob
                          ...
                          : (n.setAttribute("href", window.URL.createObjectURL(r)), n.setAttribute("download", s), (n.style.display = "none"), document.body.appendChild(n), n.click(), document.body.removeChild(n))),
    ...
    class $ {
        ...
        _createInputElement() {
            ...
            if (
                ...
                this.params.autocomplete || ((t.style.cursor = "default"), (t.style.caretColor = "transparent")),
                e && "object" == typeof e)
            )
                for (let i in e) "+" == i.charAt(0) ? ((i = i.slice(1)), t.setAttribute(i, t.getAttribute(i) + e["+" + i])) : t.setAttribute(i, e[i]);
        ...
        _initializeParams(e) {
            ...
            return (
                ...
                (t = Object.keys(e).filter((e) => i.includes(e)).length)
                    ? t > 1 && console.warn("list editor config error - only one of the values, valuesURL, or valuesLookup options can be set on the same editor")
                ...
                e.filterRemote &&
                    ...
                    !e.valuesURL &&
                    ((e.filterRemote = !1), console.warn("list editor config error - filterRemote option should only be used when values list is populated from a remote source")),
                e
            );
        }
        _bindInputEvents(e) {
        ...
        _keyDown(e) {
            var t = this.displayItems.indexOf(this.focusedItem);
            ("editor" == this.params.verticalNavigation || ("hybrid" == this.params.verticalNavigation && t < this.displayItems.length - 1)) &&
                (e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t < this.displayItems.length - 1 && (-1 == t ? this._focusItem(this.displayItems[0]) : this._focusItem(this.displayItems[t + 1])));
        }
        _keySide(e) {
        ...
        _focusItem(e) {
            (this.lastAction = "focus"),
                ...
                (this.focusedItem = e),
                e && e.element && (e.element.classList.add("focused"), e.element.scrollIntoView({ behavior: "smooth", block: "nearest", inline: "start" }));
        }
        ...
        _generateOptions(e) {
            ...
            return (
                ...
                this.params.values
                    ...
                    : this.params.valuesLookup && (t = this._uniqueColumnValues(this.params.valuesLookupField)),
        ...
        _addPlaceholder(e) {
            ...
            "function" == typeof e && (e = e(this.cell.getComponent(), this.listEl)),
                e && (this._clearList(), e instanceof HTMLElement ? (t = e) : (t.classList.add("tabulator-edit-list-placeholder"), (t.innerHTML = e)), this.listEl.appendChild(t), this._showList());
        }
        _ajaxRequest(e, t) {
            return (
                (e = V(e, {}, this.params.filterRemote ? { term: t } : {})),
                fetch(e)
                    .then((e) =>
                        e.ok
                            ? e.json().catch((e) => (console.warn("List Ajax Load Error - Invalid JSON returned", e), Promise.reject(e)))
        ...
        _parseListItem(e, t, i) {
            ...
            e.options
                ...
                : ((s = { label: e.label, value: e.value, itemParams: e.itemParams, elementAttributes: e.elementAttributes, element: !1, selected: !1, visible: !0, level: i, original: e }),
        ...
        _defaultSortFunction(e, t) {
            ...
            if (("desc" === this.params.sort && ([e, t] = [t, e]), e || 0 === e)) {
                if (t || 0 === t) {
                    ...
                    for (i = i.match(l), s = s.match(l), r = i.length > s.length ? s.length : i.length; a < r; )
                        if ((o = i[a]) !== (n = s[a++])) return isFinite(o) && isFinite(n) ? ("0" === o.charAt(0) && (o = "." + o), "0" === n.charAt(0) && (n = "." + n), o - n) : o > n ? 1 : -1;
        ...
        _chooseItem(e, t) {
            ...
            (this.typing = !1),
                this.params.multiselect
                    ? ((i = this.currentItems.indexOf(e)) > -1 ? (this.currentItems.splice(i, 1), (e.selected = !1)) : (this.currentItems.push(e), (e.selected = !0)),
                      (this.input.value = this.currentItems.map((e) => e.label).join(",")),
                      this._styleItem(e))
                    : ((this.currentItems = [e]), (e.selected = !0), (this.input.value = e.label), this._styleItem(e), t || this._resolveValue()),
                this._focusItem(e);
        }
        _resolveValue(e) {
            var t, i;
    ...
    var Z = {
        input: function (e, t, i, s, o) {
            ...
            if ((r.setAttribute("type", o.search ? "search" : "text"), (r.style.padding = "4px"), (r.style.width = "100%"), (r.style.boxSizing = "border-box"), o.elementAttributes && "object" == typeof o.elementAttributes))
            ...
            return (
                (r.value = void 0 !== n ? n : ""),
                t(function () {
                    r.focus({ preventScroll: !0 }), (r.style.height = "100%"), o.selectContents && r.select();
                }),
        ...
        textarea: function (e, t, i, s, o) {
            ...
            if (
                ...
                for (let e in o.elementAttributes) "+" == e.charAt(0) ? ((e = e.slice(1)), l.setAttribute(e, l.getAttribute(e) + o.elementAttributes["+" + e])) : l.setAttribute(e, o.elementAttributes[e]);
            function d(t) {
            ...
            return (
                (l.value = a),
                t(function () {
                    l.focus({ preventScroll: !0 }), (l.style.height = "100%"), l.scrollHeight, (l.style.height = l.scrollHeight + "px"), e.getRow().normalizeHeight(), o.selectContents && l.select();
                }),
        ...
        number: function (e, t, i, s, o) {
            ...
            return (
                t(function () {
                    a.removeEventListener("blur", l), a.focus({ preventScroll: !0 }), (a.style.height = "100%"), a.addEventListener("blur", l), o.selectContents && a.select();
                }),
        ...
        date: function (e, t, i, s, o) {
            var n = o.format,
                r = n ? window.DateTime || luxon.DateTime : null,
                a = e.getValue(),
            ...
            if (
                ...
                (l.style.width = "100%"),
                (l.style.boxSizing = "border-box"),
                o.max && l.setAttribute("max", n ? h(o.max) : o.max),
                o.min && l.setAttribute("min", n ? h(o.min) : o.min),
                o.elementAttributes && "object" == typeof o.elementAttributes)
            )
                for (let e in o.elementAttributes) "+" == e.charAt(0) ? ((e = e.slice(1)), l.setAttribute(e, l.getAttribute(e) + o.elementAttributes["+" + e])) : l.setAttribute(e, o.elementAttributes[e]);
            function d(e) {
            ...
            return (
                (a = void 0 !== a ? a : ""),
                n && (r ? (a = h(a)) : console.error("Editor Error - 'date' editor 'inputFormat' param is dependant on luxon.js")),
                (l.value = a),
                t(function () {
                    l.focus({ preventScroll: !0 }), (l.style.height = "100%"), o.selectContents && l.select();
                }),
                l.addEventListener("change", d),
                l.addEventListener("blur", d),
                l.addEventListener("keydown", function (e) {
        ...
        time: function (e, t, i, s, o) {
            var n,
                r = o.format,
                a = r ? window.DateTime || luxon.DateTime : null,
                l = e.getValue(),
                h = document.createElement("input");
            if (((h.type = "time"), (h.style.padding = "4px"), (h.style.width = "100%"), (h.style.boxSizing = "border-box"), o.elementAttributes && "object" == typeof o.elementAttributes))
                for (let e in o.elementAttributes) "+" == e.charAt(0) ? ((e = e.slice(1)), h.setAttribute(e, h.getAttribute(e) + o.elementAttributes["+" + e])) : h.setAttribute(e, o.elementAttributes[e]);
            function d(e) {
                var t = h.value;
            ...
            return (
                (l = void 0 !== l ? l : ""),
                r &&
                    (a ? ((n = a.isDateTime(l) ? l : "iso" === r ? a.fromISO(String(l)) : a.fromFormat(String(l), r)), (l = n.toFormat("hh:mm"))) : console.error("Editor Error - 'date' editor 'inputFormat' param is dependant on luxon.js")),
                (h.value = l),
                t(function () {
                    h.focus({ preventScroll: !0 }), (h.style.height = "100%"), o.selectContents && h.select();
                }),
                h.addEventListener("change", d),
                h.addEventListener("blur", d),
        ...
        datetime: function (e, t, i, s, o) {
            var n,
                ...
                l = e.getValue(),
                h = document.createElement("input");
            if (((h.type = "datetime-local"), (h.style.padding = "4px"), (h.style.width = "100%"), (h.style.boxSizing = "border-box"), o.elementAttributes && "object" == typeof o.elementAttributes))
                for (let e in o.elementAttributes) "+" == e.charAt(0) ? ((e = e.slice(1)), h.setAttribute(e, h.getAttribute(e) + o.elementAttributes["+" + e])) : h.setAttribute(e, o.elementAttributes[e]);
            function d(e) {
                var t = h.value;
            ...
            return (
                ...
                r &&
                    (a
                        ? ((n = a.isDateTime(l) ? l : "iso" === r ? a.fromISO(String(l)) : a.fromFormat(String(l), r)), (l = n.toFormat("yyyy-MM-dd") + "T" + n.toFormat("hh:mm")))
        ...
        star: function (e, t, i, s, o) {
            ...
            function p(e) {
                d.forEach(function (t, i) {
                    i < e
                        ? ("ie" == n.table.browser ? t.setAttribute("class", "tabulator-star-active") : t.classList.replace("tabulator-star-inactive", "tabulator-star-active"),
                          (t.innerHTML =
                        ...
                        : ("ie" == n.table.browser ? t.setAttribute("class", "tabulator-star-inactive") : t.classList.replace("tabulator-star-active", "tabulator-star-inactive"),
                          (t.innerHTML =
        ...
        progress: function (e, t, i, s, o) {
            ...
            if (
                ...
                for (let e in o.elementAttributes) "+" == e.charAt(0) ? ((e = e.slice(1)), p.setAttribute(e, p.getAttribute(e) + o.elementAttributes["+" + e])) : p.setAttribute(e, o.elementAttributes[e]);
            return (
        ...
        tickCross: function (e, t, i, s, o) {
            ...
            if ((r.setAttribute("type", "checkbox"), (r.style.marginTop = "5px"), (r.style.boxSizing = "border-box"), o.elementAttributes && "object" == typeof o.elementAttributes))
                for (let e in o.elementAttributes) "+" == e.charAt(0) ? ((e = e.slice(1)), r.setAttribute(e, r.getAttribute(e) + o.elementAttributes["+" + e])) : r.setAttribute(e, o.elementAttributes[e]);
            function u(e) {
                var t = r.checked;
    ...
    class Q extends k {
        ...
        initializeColumn(e) {
            var t = { editor: !1, blocked: !1, check: e.definition.editable, params: e.definition.editorParams || {} };
        ...
        focusScrollAdjust(e) {
            if ("virtual" == this.table.rowManager.getRenderMode()) {
                ...
                var o = this.table.rowManager.element.scrollLeft,
                    ...
                    r = e.getElement();
                this.table.modExists("frozenColumns") && ((o += parseInt(this.table.modules.frozenColumns.leftMargin)), (n -= parseInt(this.table.modules.frozenColumns.rightMargin))),
        ...
        edit(e, t, i) {
            ...
            if (!this.currentCell) {
                ...
                if ((t && t.stopPropagation(), this.allowEdit(e) || i)) {
                                ...
                                function (t) {
                                    if (r.currentCell === e) {
                                        ...
                                        return !0 === i || "highlight" === r.table.options.validationMode
                                            ? (r.clearEditor(), e.modules.edit || (e.modules.edit = {}), (e.modules.edit.edited = !0), -1 == r.editedCells.indexOf(e) && r.editedCells.push(e), e.setValue(t, !0), !0 === i)
                                            : ((r.invalidEdit = !0), r.focusCellNoEvent(e, !0), a(), !1);
                                    }
                                },
                                function () {
                    ...
                    l.appendChild(s), a();
                    for (var h = l.children, d = 0; d < h.length; d++)
    ...
    class ie extends k {
        ...
        generateColumnGroupHeaders() {
            var e = [];
            return (
                (!1 !== this.config.columnGroups ? this.table.columnManager.columns : this.table.columnManager.columnsByIndex).forEach((t) => {
        ...
        processColumnGroup(e) {
            var t = e.columns,
                i = 0,
                s = { title: e.definition["title" + (this.colVisProp.charAt(0).toUpperCase() + this.colVisProp.slice(1))] || e.definition.title, column: e, depth: 1 };
            if (t.length) {
                if (
                    ((s.subGroups = []),
                    (s.width = 0),
                ...
                e.columns.forEach((e) => {
                    if (e) {
                        ...
                        (t.colSpan = e.width),
                            ...
                            this.mapElementStyles(e.component.getElement(), t, ["text-align", "border-top", "border-left", "border-right", "border-bottom", "background-color", "color", "font-weight", "font-family", "font-size"]),
                            ...
                            e.component._column.parent && this.mapElementStyles(e.component._column.parent.groupElement, t, ["border-top"]),
                            s.appendChild(t);
                    }
                }),
                s
        ...
        generateGroupElement(e, t, i) {
            ...
            return (
                ...
                t.groupHeader && t.groupHeader[e.indent]
                    ? (n.value = t.groupHeader[e.indent](n.value, e.component._group.getRowCount(), e.component._group.getData(), e.component))
                    : !1 !== t.groupHeader && (n.value = e.component._group.generator(n.value, e.component._group.getRowCount(), e.component._group.getData(), e.component)),
                (o.colSpan = n.width),
                (o.innerHTML = n.value),
        ...
        generateCalcElement(e, t, i) {
            ...
            return (
                s.classList.add("tabulator-print-table-calcs"), this.mapElementStyles(i.calcRow, s, ["border-top", "border-left", "border-right", "border-bottom", "color", "font-weight", "font-family", "font-size", "background-color"]), s
            );
        }
                ...
                e.columns.forEach((o, n) => {
                    if (o) {
                        ...
                        if (
                            ...
                            d = this.table.modules.format.formatExportValue(c, this.colVisProp);
                        else
                            switch (typeof d) {
                                case "object":
                        ...
                        d instanceof Node ? a.appendChild(d) : (a.innerHTML = d),
                            (r = i.styleCells && i.styleCells[h] ? i.styleCells[h] : i.firstCell) &&
                                (this.mapElementStyles(r, a, [
                                    "padding-top",
                                    "padding-left",
                                    "padding-right",
                                    "padding-bottom",
                                ...
                                l.definition.align && (a.style.textAlign = l.definition.align)),
                            this.table.options.dataTree &&
                                !1 !== this.config.dataTree &&
                                ((t.treeElementField && t.treeElementField == l.field) || (!t.treeElementField && 0 == n)) &&
                                (e.component._row.modules.dataTree.controlEl && a.insertBefore(e.component._row.modules.dataTree.controlEl.cloneNode(!0), a.firstChild),
                                e.component._row.modules.dataTree.branchEl && a.insertBefore(e.component._row.modules.dataTree.branchEl.cloneNode(!0), a.firstChild)),
                            s.appendChild(a),
                            c.modules.format && c.modules.format.renderedCallback && c.modules.format.renderedCallback(),
                            t.rowFormatter && !1 !== this.config.formatCells && t.rowFormatter(e.component);
                    }
                }),
                s
            );
    ...
    class oe extends k {
                    ...
                    if (void 0 === e.modules.filter.prevSuccess || e.modules.filter.prevSuccess !== t) {
                        if (((e.modules.filter.prevSuccess = t), e.modules.filter.emptyFunc(t))) delete i.headerFilters[s];
                            ...
                            switch (((e.modules.filter.value = t), typeof e.definition.headerFilterFunc)) {
                                case "string":
                                    oe.filters[e.definition.headerFilterFunc]
            ...
            if (((e.modules.filter.value = t), e.modules.filter.headerElement && e.modules.filter.headerElement.parentNode && e.contentElement.removeChild(e.modules.filter.headerElement.parentNode), u)) {
                switch (
                    ...
                    case "boolean":
                        e.modules.edit && e.modules.edit.editor
                            ...
                            : e.definition.formatter && d.table.modules.edit.editors[e.definition.formatter]
                ...
                if (o) {
                    if (
                        ...
                        (h = "function" == typeof (h = e.definition.headerFilterParams || {}) ? h.call(d.table, r) : h),
                        !(n = o.call(
                        ...
                        return void console.warn("Filter Error - Cannot add filter to " + u + " column, editor returned a value of false");
        ...
        removeFilter(e, t, i) {
            Array.isArray(e) || (e = [{ field: e, type: t, value: i }]),
                e.forEach((e) => {
                    var t = -1;
                    (t = "object" == typeof e.field ? this.filterList.findIndex((t) => e === t) : this.filterList.findIndex((t) => e.field === t.field && e.type === t.type && e.value === t.value)) > -1
                        ? this.filterList.splice(t, 1)
                        : console.warn("Filter Error - No matching filter type found, ignoring: ", e.type);
                }),
                this.trackChanges();
        }
        clearFilter(e) {
    ...
    var ne = {
        ...
        money: function (e, t, i) {
            var s,
                ...
                u = t.symbol || "",
                p = !!t.symbolAfter,
                m = void 0 !== t.precision ? t.precision : 2;
            if (isNaN(a)) return this.emptyToSpace(this.sanitizeHTML(e.getValue()));
            if ((a < 0 && ((a = Math.abs(a)), (l = c)), (s = !1 !== m ? a.toFixed(m) : a), (o = (s = String(s).split("."))[0]), (n = s.length > 1 ? h + s[1] : ""), !1 !== t.thousand))
        ...
        tickCross: function (e, t, i) {
            ...
            return (a && s === t.trueValue) || (!a && ((r && s) || !0 === s || "true" === s || "True" === s || 1 === s || "1" === s))
        ...
        datetime: function (e, t, i) {
            var s,
                ...
                l = e.getValue();
            if (void 0 !== o)
                return (s = o.isDateTime(l) ? l : "iso" === n ? o.fromISO(String(l)) : o.fromFormat(String(l), n)).isValid
        ...
        datetimediff: function (e, t, i) {
            var s,
                ...
                c = e.getValue();
            if (void 0 !== o)
                return (s = o.isDateTime(c) ? c : "iso" === n ? o.fromISO(String(c)) : o.fromFormat(String(c), n)).isValid
                    ? h
    ...
    class ae extends k {
        ...
        layoutColumnPosition(e) {
            ...
            this.leftColumns.forEach((s, o) => {
                if (
                    ((s.modules.frozen.marginValue = i),
    ...
    class le extends k {
        ...
        initialize() {
            (this.rows = []),
                ...
                this.table.options.frozenRows && (this.subscribe("data-processed", this.initializeRows.bind(this)), this.subscribe("row-added", this.initializeRow.bind(this)));
        }
        initializeRows() {
            this.table.rowManager.getRows().forEach((e) => {
                this.initializeRow(e);
        ...
        initializeRow(e) {
            var t = this.table.options.frozenRows,
                i = typeof t;
            "number" === i
                ? e.getPosition() && e.getPosition() + this.rows.length <= t && this.freezeRow(e)
                : "function" === i
                ? t.call(this.table, e.getComponent()) && this.freezeRow(e)
                : Array.isArray(t) && t.includes(e.data[this.options("frozenRowsField")]) && this.freezeRow(e);
        }
        isRowFrozen(e) {
        ...
        freezeRow(e) {
            e.modules.frozen
                ...
                : ((e.modules.frozen = !0), this.topElement.appendChild(e.getElement()), e.initialize(), e.normalizeHeight(), this.rows.push(e), this.refreshData(!1, "display"), this.table.rowManager.adjustTableSize(), this.styleRows());
        }
        unfreezeRow(e) {
            e.modules.frozen
                ? ((e.modules.frozen = !1), this.detachRow(e), this.table.rowManager.adjustTableSize(), this.refreshData(!1, "display"), this.rows.length && this.styleRows())
                ...
                this.visible
                    ? this.groupList.length
                        ...
                        : ("table" != this.groupManager.table.options.columnCalcs &&
                              ...
                              ((this.calcs.top = this.groupManager.table.modules.columnCalcs.generateTopRow(this.rows)), e.push(this.calcs.top)),
                          (e = e.concat(this.rows)),
                          "table" != this.groupManager.table.options.columnCalcs &&
                              this.groupManager.table.modExists("columnCalcs") &&
                              this.groupManager.table.modules.columnCalcs.hasBottomCalcs() &&
                              ((this.calcs.bottom = this.groupManager.table.modules.columnCalcs.generateBottomRow(this.rows)), e.push(this.calcs.bottom)))
                    : this.groupList.length ||
                      "table" == this.groupManager.table.options.columnCalcs ||
                      (this.groupManager.table.modExists("columnCalcs") &&
                          (this.groupManager.table.modules.columnCalcs.hasTopCalcs() &&
    ...
    class ce extends k {
            ...
            if (this.table.options.groupBy) {
                ...
                return (
                    s.length > 1 &&
                        (!t || (t && -1 == s.indexOf(t))
                            ? i
                                ? s[0] !== e && ((t = s[0]), this.table.rowManager.moveRowInArray(e.modules.group.rows, e, t, !i))
                                : s[s.length - 1] !== e && ((t = s[s.length - 1]), this.table.rowManager.moveRowInArray(e.modules.group.rows, e, t, !i))
                            : this.table.rowManager.moveRowInArray(e.modules.group.rows, e, t, !i)),
                    t
                );
            }
        }
        ...
        getRows(e) {
            return this.table.options.groupBy && this.groupIDLookups.length
                ? (this.dispatchExternal("dataGrouping"), this.generateGroups(e), this.subscribedExternal("dataGrouped") && this.dispatchExternal("dataGrouped", this.getGroups(!0)), this.updateGroupRows())
                : e.slice(0);
        }
        getGroups(e) {
            var t = [];
    ...
    class pe extends k {
        ...
        tableElementCheck() {
            this.table.originalElement &&
                ...
                (this.table.originalElement.childNodes.length ? this.parseTable() : console.warn("Unable to parse data from empty table tag, Tabulator should be initialized on a div tag unless importing data from a table element."));
        }
        parseTable() {
        ...
        _extractHeaders(e, t) {
            for (var i = 0; i < e.length; i++) {
                ...
                r ? (n = !0) : (r = { title: o.textContent.trim() }),
                    r.field || (r.field = o.textContent.trim().toLowerCase().replace(" ", "_")),
        ...
        importFromFile(e, t) {
            ...
            if (i)
                return this.pickFile(t)
                    ...
                    .catch((e) => (console.error("Import Error:", e || "Unable to import file"), Promise.reject(e)));
        }
        pickFile(e) {
    ...
    class be extends k {
        ...
        cellContentsSelectionFixer(e, t) {
            ...
            if (!this.table.modExists("edit") || this.table.modules.edit.currentCell !== t) {
                ...
                try {
                    document.selection
                        ? ((i = document.body.createTextRange()).moveToElementText(t.getElement()), i.select())
                        : window.getSelection && ((i = document.createRange()).selectNode(t.getElement()), window.getSelection().removeAllRanges(), window.getSelection().addRange(i));
                } catch (e) {}
            }
        }
        ...
        subscriptionChanged(e, t) {
            t
                ? this.subscribers[e] || (this.eventMap[e].includes("-") ? ((this.subscribers[e] = this.handle.bind(this, e)), this.subscribe(this.eventMap[e], this.subscribers[e])) : this.subscribeTouchEvents(e))
                : this.eventMap[e].includes("-")
                ? !this.subscribers[e] || this.columnSubscribers[e] || this.subscribedExternal(e) || (this.unsubscribe(this.eventMap[e], this.subscribers[e]), delete this.subscribers[e])
                : this.unsubscribeTouchEvents(e);
        }
        subscribeTouchEvents(e) {
            var t = this.eventMap[e];
            this.touchSubscribers[t + "-touchstart"] ||
                ((this.touchSubscribers[t + "-touchstart"] = this.handleTouch.bind(this, t, "start")),
    ...
    class fe extends k {
        ...
        mapBinding(e, t) {
            var i = { action: fe.actions[e], keys: [], ctrl: !1, shift: !1, meta: !1 };
            t.toString()
                .toLowerCase()
                .split(" ")
                .join("")
    ...
    class we extends k {
            ...
            e.modules.frozen ||
                ...
                (s.mousemove = function (s) {
                    e.parent === i.moving.parent &&
                        ((i.touchMove ? s.touches[0].pageX : s.pageX) - r.elOffset(t).left + i.table.columnManager.contentsElement.scrollLeft > e.getWidth() / 2
                            ? (i.toCol === e && i.toColAfter) || (t.parentNode.insertBefore(i.placeholderElement, t.nextSibling), i.moveColumn(e, !0))
                            : (i.toCol !== e || i.toColAfter) && (t.parentNode.insertBefore(i.placeholderElement, t), i.moveColumn(e, !1)));
                }.bind(i)),
                    ...
                    (a) => {
                        ...
                        this.moving &&
                            ...
                            (h = a.touches[0].pageX - l) > 0
                                ? t && h - n > s && (d = t) !== e && ((l = a.touches[0].pageX), d.getElement().parentNode.insertBefore(this.placeholderElement, d.getElement().nextSibling), this.moveColumn(d, !0))
                                : i && -h - r > o && (d = i) !== e && ((l = a.touches[0].pageX), d.getElement().parentNode.insertBefore(this.placeholderElement, d.getElement()), this.moveColumn(d, !1)),
        ...
        startMove(e, t) {
            ...
            (this.moving = t),
                (this.startX = (this.touchMove ? e.touches[0].pageX : e.pageX) - r.elOffset(i).left),
    ...
    class Ce extends k {
        ...
        initializeGroupHeader(e) {
            ...
            (i.mouseup = function (i) {
                ...
                (i.mousemove = function (i) {
                    var s;
                    i.pageY - r.elOffset(e.element).top + t.table.rowManager.element.scrollTop > e.getHeight() / 2
                        ? (t.toRow === e && t.toRowAfter) || ((s = e.getElement()).parentNode.insertBefore(t.placeholderElement, s.nextSibling), t.moveRow(e, !0))
                        : (t.toRow !== e || t.toRowAfter) && (s = e.getElement()).previousSibling && (s.parentNode.insertBefore(t.placeholderElement, s), t.moveRow(e, !1));
                }.bind(t)),
                (e.modules.moveRow = i);
        }
        initializeRow(e) {
            ...
            (s.mouseup = function (t) {
                ...
                (s.mousemove = function (t) {
                    var s = e.getElement();
                    t.pageY - r.elOffset(s).top + i.table.rowManager.element.scrollTop > e.getHeight() / 2
                        ? (i.toRow === e && i.toRowAfter) || (s.parentNode.insertBefore(i.placeholderElement, s.nextSibling), i.moveRow(e, !0))
                        : (i.toRow !== e || i.toRowAfter) && (s.parentNode.insertBefore(i.placeholderElement, s), i.moveRow(e, !1));
                }.bind(i)),
                this.hasHandle ||
                ...
                t.addEventListener("touchmove", (t) => {
                    ...
                    this.moving &&
                        ...
                        (h = t.touches[0].pageY - l) > 0
                            ? i && h - r > o && (d = i) !== e && ((l = t.touches[0].pageY), d.getElement().parentNode.insertBefore(this.placeholderElement, d.getElement().nextSibling), this.moveRow(d, !0))
                            : s && -h - a > n && (d = s) !== e && ((l = t.touches[0].pageY), d.getElement().parentNode.insertBefore(this.placeholderElement, d.getElement()), this.moveRow(d, !1)),
        ...
        connectToTables(e) {
            ...
            this.connectionSelectorsTables &&
                ((t = this.commsConnections(this.connectionSelectorsTables)), this.dispatchExternal("movableRowsSendingStart", t), this.commsSend(this.connectionSelectorsTables, "moveRow", "connect", { row: e })),
        ...
        dropComplete(e, t, i) {
            ...
            if (i) {
                ...
                s
                    ? s.call(this, this.moving ? this.moving.getComponent() : void 0, t ? t.getComponent() : void 0, e)
        ...
        tableRowDrop(e, t) {
            ...
            i ? (s = i.call(this, this.connectedRow.getComponent(), t ? t.getComponent() : void 0, this.connectedTable)) : console.warn("Mover Row Error - no matching receiver found:", this.table.options.movableRowsReceiver),
                s
                    ? this.dispatchExternal("movableRowsReceived", this.connectedRow.getComponent(), t ? t.getComponent() : void 0, this.connectedTable)
                    : this.dispatchExternal("movableRowsReceivedFailed", this.connectedRow.getComponent(), t ? t.getComponent() : void 0, this.connectedTable),
                ...
                this.enabled &&
                    this.table.columnManager.traverse((n) => {
                        ...
                        n.modules.mutate &&
                            ...
                            ("data" != t && void 0 === s) || ((l = n.getComponent()), (a = "function" == typeof r.params ? r.params(s, e, t, l) : r.params), n.setFieldValue(e, r.mutator(s, e, t, a, l))));
                    }),
                e
            );
        }
    ...
    var ye = {
        rows: function (e, t, i, s, o) {
            ...
            return (
                ...
                s
                    ? ((a.innerHTML = " " + t + "-" + Math.min(t + e - 1, s) + " "), (h.innerHTML = " " + s + " "), n.appendChild(r), n.appendChild(a), n.appendChild(l), n.appendChild(h), n.appendChild(d))
                    : ((a.innerHTML = " 0 "), n.appendChild(r), n.appendChild(a), n.appendChild(d)),
                n
            );
        },
    ...
    class Re extends k {
        ...
        initializePageCounter() {
            var e = this.table.options.paginationCounter,
                t = null;
            e &&
                ((t = "function" == typeof e ? e : Re.pageCounters[e])
                    ? ((this.pageCounter = t), (this.pageCounterElement = document.createElement("span")), this.pageCounterElement.classList.add("tabulator-page-counter"))
        ...
        setPage(e) {
            ...
            return ((e = parseInt(e)) > 0 && e <= this.max) || "local" !== this.mode
                ...
                : (console.warn("Pagination Error - Requested page is out of range of 1 - " + this.max + ":", e), Promise.reject());
        }
        setPageToRow(e) {
        ...
        _parseRemoteData(e) {
            ...
            if ((void 0 === e.last_page && console.warn("Remote Pagination Error - Server response missing '" + (this.options("dataReceiveParams").last_page || "last_page") + "' property"), e.data)) {
                if (
                    ((this.max = parseInt(e.last_page) || 1), (this.remoteRowCountEstimate = void 0 !== e.last_row ? e.last_row : e.last_page * this.size - (this.page == e.last_page ? this.size - e.data.length : 0)), this.progressiveLoad)
                ) {
                    switch (this.mode) {
                        case "progressive_load":
    ...
    class ke extends k {
                ...
                (this.mode = !0 !== t ? t : this.localStorageTest() ? "local" : "cookie"),
                    this.table.options.persistenceReaderFunc
                        ? "function" == typeof this.table.options.persistenceReaderFunc
                            ...
                            : ke.readers[this.table.options.persistenceReaderFunc]
                            ? (this.readFunc = ke.readers[this.table.options.persistenceReaderFunc])
                            : console.warn("Persistence Read Error - invalid reader set", this.table.options.persistenceReaderFunc)
                        : ke.readers[this.mode]
                        ? (this.readFunc = ke.readers[this.mode])
                        : console.warn("Persistence Read Error - invalid reader set", this.mode),
                    this.table.options.persistenceWriterFunc
                        ? "function" == typeof this.table.options.persistenceWriterFunc
                            ? (this.writeFunc = this.table.options.persistenceWriterFunc)
                            : ke.writers[this.table.options.persistenceWriterFunc]
                            ? (this.writeFunc = ke.writers[this.table.options.persistenceWriterFunc])
                            : console.warn("Persistence Write Error - invalid reader set", this.table.options.persistenceWriterFunc)
                        : ke.writers[this.mode]
                        ? (this.writeFunc = ke.writers[this.mode])
        ...
        mergeDefinition(e, t) {
            ...
            return (
                (t = t || []).forEach((t, s) => {
                    ...
                    n &&
                        (!0 === this.config.columns || null == this.config.columns ? (o = Object.keys(n)).push("width") : (o = this.config.columns),
                        o.forEach((e) => {
        ...
        getGroupConfig() {
            ...
            return (
                this.config.group &&
                    ((!0 === this.config.group || this.config.group.groupBy) && (e.groupBy = this.table.options.groupBy),
    ...
    class Le extends k {
        ...
        initialize() {
            this.table.options.printAsHtml && (window.addEventListener("beforeprint", this.replaceTable.bind(this)), window.addEventListener("afterprint", this.cleanup.bind(this))),
                ...
                Object.defineProperty(this.data, "shift", {
                    ...
                    value: function () {
                        ...
                        return (
                            i.blocked ||
                                t !== i.currentVersion ||
                                (i.block("data-shift"), i.data.length && (s = i.table.rowManager.getRowFromDataObject(i.data[0])) && s.deleteActual(), (o = i.origFuncs.shift.call(e)), i.unblock("data-shift")),
                            o
                        );
                    },
                }),
                ...
                Object.defineProperty(this.data, "pop", {
                    ...
                    value: function () {
                        ...
                        return (
                            i.blocked ||
                                t !== i.currentVersion ||
                                (i.block("data-pop"), i.data.length && (s = i.table.rowManager.getRowFromDataObject(i.data[i.data.length - 1])) && s.deleteActual(), (o = i.origFuncs.pop.call(e)), i.unblock("data-pop")),
                            o
                        );
                    },
                }),
        ...
        _mouseDown(e, t, i) {
            ...
            function n(e) {
                s.startColumn.modules.edit && (s.startColumn.modules.edit.blocked = !1),
                    ...
                    s.startWidth !== t.getWidth() && (s.table.columnManager.verticalAlignHeaders(), s.dispatch("column-resized", t), s.table.externalEvents.dispatch("columnResized", t.getComponent()));
            }
                              ...
                              ((this.containerObserver = new ResizeObserver((e) => {
                                  if (!t.browserMobile || (t.browserMobile && !t.modules.edit.currentCell)) {
                                      ...
                                      (this.containerHeight == i && this.containerWidth == s) ||
                                          ((this.containerHeight = i), (this.containerWidth = s), (this.tableHeight = t.element.clientHeight), (this.tableWidth = t.element.clientWidth)),
                                          this.redrawTable();
                                  }
                              })),
    ...
    class Fe extends k {
        ...
        initializeRow(e) {
            var t;
            "calc" !== e.type &&
                ((t = document.createElement("div")).classList.add("tabulator-responsive-collapse"), (e.modules.responsiveLayout = { element: t, open: this.collapseStartOpen }), this.collapseStartOpen || (t.style.display = "none"));
        }
        layoutRow(e) {
            var t = e.getElement();
        ...
        showColumn(e) {
            ...
            e.show(!1, !0),
                ...
                "collapse" === this.mode &&
                    ((t = this.hiddenColumns.indexOf(e)) > -1 && this.hiddenColumns.splice(t, 1), this.generateCollapsedContent(), this.collapseHandleColumn && !this.hiddenColumns.length && this.collapseHandleColumn.hide());
        }
        update() {
            for (var e = !0; e; ) {
    ...
    class He extends k {
                    ...
                    ? (i.classList.add("tabulator-selectable"),
                      ...
                      t.table.options.selectable &&
                          ...
                          ("click" === t.table.options.selectableRangeMode
                              ? i.addEventListener("click", this.handleComplexRowClick.bind(this, e))
        ...
        handleComplexRowClick(e, t) {
            if (t.shiftKey) {
                ...
                t.ctrlKey || t.metaKey
                    ...
                    : (this.deselectRows(void 0, !0), !0 !== this.table.options.selectable && r.length > this.table.options.selectable && (r = r.slice(0, this.table.options.selectable)), this.selectRows(r)),
            ...
            switch (typeof e) {
                ...
                case "string":
                    (t = this.table.rowManager.findRow(e))
                        ? (this._selectRow(t, !0, !0), this._rowSelectionChanged())
                        : ((t = this.table.rowManager.getRows(e)).forEach((e) => {
                              this._selectRow(e, !0, !0);
                          }),
        ...
        _deselectRow(e, t) {
            ...
            o
                ? (i = s.selectedRows.findIndex(function (e) {
                  ...
                  o.modules.select.checkboxEl && (o.modules.select.checkboxEl.checked = !1),
                  s.selectedRows.splice(i, 1),
                  this.table.options.dataTreeSelectPropagate && this.childRowSelection(o, !1),
        ...
        _rowSelectionChanged(e) {
            this.headerCheckboxElement &&
                ...
                e || this.dispatchExternal("rowSelectionChanged", this.getSelectedData(), this.getSelectedRows());
        }
    ...
    var Ae = {
        number: function (e, t, i, s, o, n, r) {
            var a = r.alignEmptyValues,
                ...
                d = 0;
            if (((e = String(e)), (t = String(t)), h && ((e = e.split(h).join("")), (t = t.split(h).join(""))), l && ((e = e.split(l).join(".")), (t = t.split(l).join("."))), (e = parseFloat(e)), (t = parseFloat(t)), isNaN(e)))
                d = isNaN(t) ? 0 : -1;
            else {
        ...
        alphanum: function (e, t, i, s, o, n, r) {
            ...
            if (e || 0 === e) {
                if (t || 0 === t) {
                    ...
                    for (a = a.match(p), l = l.match(p), c = a.length > l.length ? l.length : a.length; u < c; )
                        if ((h = a[u]) !== (d = l[u++])) return isFinite(h) && isFinite(d) ? ("0" === h.charAt(0) && (h = "." + h), "0" === d.charAt(0) && (d = "." + d), h - d) : h > d ? 1 : -1;
    ...
    class _e extends k {
        ...
        initializeColumn(e) {
            ...
            if (((e.modules.sort = { sorter: s, dir: "none", params: e.definition.sorterParams || {}, startingDir: e.definition.headerSortStartingDir || "asc", tristate: e.definition.headerSortTristate }), !1 !== e.definition.headerSort)) {
                if (((t = e.getElement()).classList.add("tabulator-sortable"), (i = document.createElement("div")).classList.add("tabulator-col-sorter"), "icon" === this.table.options.headerSortClickElement))
                ...
                e.titleHolderElement.appendChild(i),
                    ...
                    ("icon" === this.table.options.headerSortClickElement ? i : t).addEventListener("click", (t) => {
                        ...
                        if (e.modules.sort) {
                            ...
                            this.table.options.columnHeaderSortMulti && (t.shiftKey || t.ctrlKey)
                                ? ((o = (s = this.getSort()).findIndex((t) => t.field === e.getField())),
                                  o > -1 ? ((s[o].dir = i), (o = s.splice(o, 1)[0]), "none" != i && s.push(o)) : "none" != i && s.push({ column: e, dir: i }),
                                  this.setSort(s))
                                : "none" == i
                                ? this.clear()
                                : this.setSort(e, i),
        ...
        sort(e) {
            var t = this,
                ...
                o = [];
            return (
                this.subscribedExternal("dataSorting") && this.dispatchExternal("dataSorting", t.getSort()),
                t.clearColumnHeaders(),
                "remote" !== this.table.options.sortMode
                    ? (i.forEach(function (e, i) {
                          var o;
                          e.column &&
                              ((o = e.column.modules.sort) && (o.sorter || (o.sorter = t.findSorter(e.column)), (e.params = "function" == typeof o.params ? o.params(e.column.getComponent(), e.dir) : o.params), s.push(e)),
        ...
        loadTooltip(e, t, i) {
            ...
            "function" == typeof i &&
                ...
                (i || 0 === i || !1 === i) &&
                    ...
                    "function" == typeof n && this.popupInstance.renderCallback(n),
    ...
    class Ie extends k {
        ...
        validate(e, t, i) {
            ...
            return (
                ...
                o.length
                    ? ((t.modules.validate.invalid = o), "manual" !== this.table.options.validationMode && t.getElement().classList.add("tabulator-validation-fail"), -1 == n && this.invalidCells.push(t))
                    : ((t.modules.validate.invalid = !1), t.getElement().classList.remove("tabulator-validation-fail"), n > -1 && this.invalidCells.splice(n, 1)),
                !o.length || o
            );
        }
        getInvalidCells() {
