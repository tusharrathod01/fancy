...
(function (global, factory) {
	...
	class Menu extends Module{
		...
		initializeColumnHeaderMenu(column){
			...
			var icon2 = column.definition.headerMenuIcon,
			headerMenuEl2;

			headerMenuEl = document.createElement("span");
			headerMenuEl.classList.add("tabulator-header-popup-button");
			
			headerMenuEl2 = document.createElement("span");
			headerMenuEl2.classList.add("tabulator-header-popup-button");
			...
			if(icon2){
				if(typeof icon === "function"){
					icon2 = icon(column.getComponent());
				}
				
				if(icon instanceof HTMLElement){
					headerMenuEl2.appendChild(icon);
				}else {
					headerMenuEl2.innerHTML = icon;
				}
			}else {
				headerMenuEl2.innerHTML = "<i class='fa fa-filter'></i>";
			}
			...
			headerMenuEl2.addEventListener("click", (e) => {
				e.stopPropagation();
				e.preventDefault();
				this.loadMenuEvent(column.definition.filterMenu, e, column);
			});

			column.titleElement.insertBefore(headerMenuEl, column.titleElement.firstChild);
			column.titleElement.insertBefore(headerMenuEl2, column.titleElement.firstChild);
